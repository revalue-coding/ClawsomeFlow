...
const en = {
  ...
  flowEditor: {
    ...
    taskFields: {
      ...
      externalRemoteHint: "Delegates to a Flow on a remote ClawsomeFlow; its final report becomes this node’s output. Click \"Copy remote call info\" on the target Flow's editor, paste it above, then save the subtask.",
      externalRemoteHintWithParams: "Delegates to a Flow on a remote ClawsomeFlow; its final report becomes this node’s output. Click \"Copy remote call info\" on the target Flow's editor, paste it above, then save the subtask. The remote Flow declares param fields: upstream tasks are asked to report values for them; below you may optionally fill values you already know (they override the upstream reports).",
