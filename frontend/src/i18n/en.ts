...
const en = {
  ...
  flowEditor: {
    ...
    remoteCallInfoCopied:
      "Remote call info copied to clipboard. Paste it into the origin Flow's \"Remote ClawsomeFlow\" subtask (\"Remote Flow call info\" box) and click \"Parse & register\".",
    ...
    validation: {
      ...
      externalRemoteFieldsRequired: "\"{{subject}}\": Remote ClawsomeFlow — paste the \"Remote Flow call info\" and click \"Parse & register\" first.",
    ...
    taskFields: {
      ...
      externalRemoteCallInfoPlaceholder:
        "On the target Flow's editor click \"Copy remote call info\", paste the JSON here, then click \"Parse & register\".",
      ...
      externalRemoteRegister: "Parse & register",
      externalRemoteRegistering: "Registering…",
      externalRemoteRegistered:
        "Registered remote Flow \"{{flowName}}\". Param fields: {{fields}}. The credential was saved locally, never into the Flow.",
      ...
      externalRemoteHint: "Delegates to a Flow on a remote ClawsomeFlow; its final report becomes this node’s output. Just click \"Copy remote call info\" on the target Flow's editor, paste it above and \"Parse & register\" — the base URL / Flow ID / credential are wired automatically, no CLI needed. Upstream tasks are asked to additionally report the remote param-field values; below you may optionally fill values you already know (they override the upstream reports).",
