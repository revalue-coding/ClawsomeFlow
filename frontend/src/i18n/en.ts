...
const en = {
  ...
  flowEditor: {
    ...
    taskFields: {
      ...
      externalRemoteHint: "Delegates to a Flow on a remote ClawsomeFlow; its final report becomes this node’s output. Pairing: remote csflow external pair-token <name> → local csflow external add-remote <name> <secret> → fill that name above. The task sheet is sent as the remote runtime prompt; if the remote Flow has param fields, set them in the JSON below (static values today).",
