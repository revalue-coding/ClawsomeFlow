...
const en = {
  ...
  runDetail: {
    ...
    viewDiff: "View diff",
    diffModalTitle: "Diff — {{agent}}",
    diffEmpty: "No changes against the base branch.",
    diffTruncated: "Diff is too large and has been truncated. View the full diff in the worktree.",
    diffUncommitted: "Uncommitted changes (will NOT be merged)",
    diffBranchAhead: "{{count}} commit(s) will be merged",
    diffBaseAhead:
      "The target branch has {{count}} new commit(s) since this worktree was created (not shown in the diff below). Merging brings your commits on top; conflicts may need reconciling.",
