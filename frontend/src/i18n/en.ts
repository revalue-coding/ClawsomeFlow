...
const en = {
  ...
  flowEditor: {
    ...
    validation: {
      ...
      externalChannelRequired: "\"{{subject}}\": pick a channel for the external executor.",
      externalEndpointRequired: "\"{{subject}}\": the webhook channel requires an endpoint URL.",
      externalRemoteFieldsRequired: "\"{{subject}}\": the remote ClawsomeFlow channel requires base URL, Flow ID and pairing credential name.",
    ...
    taskFields: {
      ...
      ownerSourceExternal: "External executor",
      ...
      ownerKindExternal: "External executor",
      externalNamePlaceholder: "Node name, e.g. reviewer-alice / partner-system",
      externalChannel: "Channel *",
      externalChannelPlaceholder: "— pick a channel —",
      externalChannelHuman: "Human (WebUI card)",
      ...
      externalHumanHint: "The task appears as a todo card on the Run page; a person completes it and submits the result there. No process is spawned and no worktree is created.",
      externalWebhookHint: "On dispatch, ClawsomeFlow POSTs the task package (with a one-time callback ticket) to this endpoint; the external system calls back /api/external when done.",
      externalRemoteHint: "The task is delegated to a Flow on a remote ClawsomeFlow instance; its leader report becomes this node's output. Register the credential first: csflow external add-remote <name> <secret>.",
