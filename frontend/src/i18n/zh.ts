...
const zh = {
  ...
  runDetail: {
    ...
    delegatedNotice:
      "该 Run 由远程 ClawsomeFlow 委派执行，会自动跳过人工检查点、合并审查以及投诉阶段。配对凭据：{{pairToken}}；来源执行流：{{sourceRun}}；来源任务：{{sourceTask}}。",
    pausedTitle: "执行流已暂停",
    ...
    pauseFailureSyntheticDispatchFailed: "任务派发到该节点失败{{detail}}",
    ...
    external: {
      ...
      submitFailed: "报告失败",
      redispatch: "重新派发",
      redispatchConfirm: "重新派发任务后，之前的派发将作废",
